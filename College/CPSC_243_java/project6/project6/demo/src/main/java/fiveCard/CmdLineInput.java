...
/**
 * Enables command line input and validation for populating player and banker hands for smoother testing.
...
/**                                                   
*      Populates map with all possible card ranks for duplicate checking
*/
