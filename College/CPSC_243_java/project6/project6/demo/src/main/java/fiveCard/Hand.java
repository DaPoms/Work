...
public class Hand implements Comparable<Hand>{
    ...
    */
    public void addCard(Card c) throws PokerException//ensures adding is done in a sorted manner (with insertion sort)
    {
        if (c == null)
    ...
    */
    public void removeCard(int i) throws PokerException
    {
