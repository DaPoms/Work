 ...
 * @author Daniel Tripoli
 */
public class PokerHand extends Hand // Can only be package private within the SAME FILE
{    
    /**                                                   
    ...
    */ 
    public class cardByCountAndRank 
    {
    ...
    */
    public cardByCountAndRank[] top2PairCount() //assumes that hand is of size 5 
    {
    ...
    */
    public static int[] getKickerArr(Hand hand, cardByCountAndRank[] top2Cards, int nonKickerCardCount) throws PokerException
    {
    ...
    */
    public static void sortTop2CardArrayByRank(cardByCountAndRank[] arr)
    {
        cardByCountAndRank placeholder;
    ...
    *      @throws PokerException If trying to get card at invalid index
    */     
    public static HandResult kickerBreakTie(Hand caller, Hand dealer, cardByCountAndRank[] callerTop2Cards, cardByCountAndRank[] dealerTop2Cards) throws PokerException
    {
    ...
    */     
    public static HandResult breakTie(cardByCountAndRank[] callerTop2Cards, cardByCountAndRank[] dealerTop2Cards, int handRankVal)
    {
    ...
    *      @return The result of the tie break. Win and lose entail the entire hand was won or lost, push guarantees that a complete tie occured
    */  
    public static HandResult breakTie(int[] intCallerHand, int[] intDealerHand) 
    {  
    ...
    */  
    public static boolean hasKickers(HandRank handRank) 
    {
        switch(handRank)
        {
    ...
    *      @throws PokerException If trying to get card at invalid index
    */ 
    public static HandResult isCallerWinner(PokerHand caller, PokerHand dealer) throws PokerException
    {
    ...
    */ 
    public static boolean hasAceAsLowest(int[] hand, HandRank rankType)
    {
    ...
    *      @param hand The hand we insert the ace into
    */ 
    public static void insertAceToFront(int[] hand)
    {
    ...
    *      @param rankType The hand rank of the hand we pass through
    */ 
    public static void adjustAceValueIfNeeded(int[] hand, HandRank rankType)
    {
    ...
    *      @throws PokerException If trying to get card at invalid index
    */  
    public static HandResult isCallerWinnerForTie(HandRank rankType, PokerHand caller, PokerHand dealer) throws PokerException //has to account properly for ties. rankType is passed just to take advantage of isCallerWinner already using getHandRank()
    {
