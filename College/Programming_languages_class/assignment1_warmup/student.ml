...
let test_log _ =
  ...
  assert_equal 6 (log 2 103) ~msg:"student_pow (2)"
...
let test_shift_left _ = 
  ...
  assert_equal ["a"; "b"; "c"; "d"] (shift_left 0 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (1)";
  assert_equal ["b"; "c"; "d"; "a"] (shift_left 1 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (2)";
  assert_equal ["c"; "d"; "a"; "b"] (shift_left 2 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (3)"; 
  assert_equal ["d"; "a"; "b"; "c"] (shift_left 3 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (3)"; 
  assert_equal ["a"; "b"; "c"; "d"] (shift_left 4 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (3)"; 
  assert_equal ["b"; "c"; "d"; "a"] (shift_left 5 ["a"; "b"; "c"; "d"]) ~msg: "student_shift_left (3)"
